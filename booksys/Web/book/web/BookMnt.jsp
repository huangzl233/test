...
%>     
    <li>
        <a data-rel="external" data-ajax="false" href="BookDisplay.jsp?id=<%=rs.getObject("Id")%>">
...
<a href="BookAdd.jsp" data-rel="external" data-ajax="false" class="ui-btn ui-mini" >新增</a>
