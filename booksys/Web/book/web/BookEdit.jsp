...
<form action="BookEdit.jsp" method="post" data-ajax="false">
    ...
    <input name="fName" id="fName" type="text" value="<%=((rs.getObject("Name") == null) ? "" : rs.getObject("Name"))%>" placeholder="名称" >
    ...
    <input name="fPrice" id="fPrice" type="text" value="<%=((rs.getObject("Price") == null) ? "" : rs.getObject("Price"))%>" placeholder="价格" >

    <label for="fIntroduction">介绍：</label>
    <input name="fIntroduction" id="fIntroduction" type="text" value="<%=((rs.getObject("Introduction") == null) ? "" : rs.getObject("Introduction"))%>" placeholder="介绍" >
    <label for="fQty">数量：</label>
    <input name="fQty" id="fQty" type="text" value="<%=((rs.getObject("Qty") == null) ? "" : rs.getObject("Qty"))%>" placeholder="数量" 
    </div>
