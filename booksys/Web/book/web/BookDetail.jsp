...
%>
    ...
    <a href="MyAppointments.jsp?Action=appointment&id=<%=id%>" data-rel="external" data-ajax="false" class="ui-btn ui-mini" >预约</a>

<%}%>

<a href="BookSearch.jsp" data-rel="external" data-ajax="false" class="ui-btn ui-mini" >返回</a>
