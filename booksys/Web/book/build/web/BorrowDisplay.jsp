...
if(action!=null && action.equalsIgnoreCase("return")){
    sql = "UPDATE `appointment` SET `Status`='已归还', `ReturnTime`=now() WHERE `Id`=" + id;
...
%>
    ...
    <a href="BorrowDisplay.jsp?Action=return&id=<%=id%>" data-rel="external" data-ajax="false" class="ui-btn ui-mini" >归还</a>
<%}%>

<a href="BorrowMnt.jsp" data-rel="external" data-ajax="false" class="ui-btn ui-mini" >返回</a>
